...
class Enemy_zombie_dos:
    def __init__(self,x,y,speed_walk,speed_run,gravity,jump_power,frame_rate_ms,move_rate_ms,jump_height,estado_inicial=None,recorrido=None,direction=None) -> None:
        ...
        self.attack_r = Auxiliar.getSurfaceFromSpriteSheet("zombies/attack_zombie_2.png",11,1)
        self.attack_l = Auxiliar.getSurfaceFromSpriteSheet("zombies/attack_zombie_2.png",11,1,True)
        ...
        self.rect_disparo = pygame.Rect(self.rect.x+15 + self.rect.w / 5, self.rect.y+30, self.rect.w / 2.5, 70)
