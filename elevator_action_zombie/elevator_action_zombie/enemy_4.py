...
class Enemy_zombie_cuatro:
    def __init__(self,x,y,speed_walk,speed_run,gravity,jump_power,frame_rate_ms,move_rate_ms,jump_height,estado_inicial=None,recorrido=None,direction=None) -> None:
        self.walk_r = Auxiliar.getSurfaceFromSpriteSheet("zombies/Walk_zombie_police.png",8,1)
        self.walk_l = Auxiliar.getSurfaceFromSpriteSheet("zombies/Walk_zombie_police.png",8,1,True)
        self.stay_r = Auxiliar.getSurfaceFromSpriteSheet("zombies/Idle_zombie_police.png",6,1)
        self.stay_l = Auxiliar.getSurfaceFromSpriteSheet("zombies/Idle_zombie_police.png",6,1,True)
        self.run_r = Auxiliar.getSurfaceFromSpriteSheet("zombies/Run_zombie_police.png",8,1)
        self.run_l = Auxiliar.getSurfaceFromSpriteSheet("zombies/Run_zombie_police.png",8,1,True)
